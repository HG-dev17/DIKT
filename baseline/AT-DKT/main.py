...
if __name__ == '__main__':
    ...
    model_name = ATDKTConfig.MODEL_NAME
    emb_size = ATDKTConfig.EMB_SIZE
    dropout = ATDKTConfig.DROPOUT
    emb_type = ATDKTConfig.EMB_TYPE
    num_layers = ATDKTConfig.NUM_LAYERS
    num_attn_heads = ATDKTConfig.NUM_ATTN_HEADS
    l1 = ATDKTConfig.L1
    l2 = ATDKTConfig.L2
    l3 = ATDKTConfig.L3
    start = ATDKTConfig.START
    lr = ATDKTConfig.LEARNING_RATE
    epoch = ATDKTConfig.NUM_EPOCHS
    batch_size = ATDKTConfig.BATCH_SIZE
    max_seq = ATDKTConfig.SEQ_LEN
    min_seq = ATDKTConfig.MIN_SEQ_LEN
    ...
    for fold in range(5):
        ...
        model = ATDKT(pro_max, skill_max, max_seq, emb_size, dropout, emb_type, num_layers, num_attn_heads, l1, l2, l3,
                      start).to(device)
