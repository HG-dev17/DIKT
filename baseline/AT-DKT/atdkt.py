...
class ATDKT(Module):
    ...
    def predcurc(self, smasks, historycorrs, q, c, r, xemb, train):
    ...
    def forward(self, qseqs, cseqs, rseqs, smasks, historycorrs, train=False): ## F * xemb
        q, c, r = qseqs.long(), cseqs.long(), rseqs.long()
        ...
        if emb_type == "qid":
            ...
            y, y2, y3 = self.predcurc(smasks, historycorrs, q, c, r, xemb, train)
