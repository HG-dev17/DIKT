...
class CL4KT(Module):
    def __init__(self, num_skills):
        ...
        self.hidden_size = CL4KTConfig.HIDDEN_SIZE
        self.num_blocks = CL4KTConfig.NUM_BLOCKS
        self.num_attn_heads = CL4KTConfig.NUM_ATTN_HEADS
        self.kq_same = CL4KTConfig.KQ_SAME
        self.final_fc_dim = CL4KTConfig.FINAL_FC_DIM
        self.d_ff = CL4KTConfig.D_FF
        self.l2 = CL4KTConfig.L2
        self.dropout = CL4KTConfig.DROPOUT
        self.reg_cl = CL4KTConfig.REG_CL
        self.negative_prob = CL4KTConfig.NEGATIVE_PROB
        self.hard_negative_weight = CL4KTConfig.HARD_NEGATIVE_WEIGHT
        ...
        self.sim = Similarity(temp=CL4KTConfig.TEMP)
    ...
    def forward(self, batch):
        if self.training:
            ...
            attention_mask_i, attention_mask_j, attention_mask = batch["mask"]
