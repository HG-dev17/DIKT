...
from config import PKTConfig


class DKTInSkillQues(nn.Module):

    def __init__(self, nSkill, nQues, szRnnIn, szRnnOut, nRnnLayer, szOut, dropout):
    ...
    def init_hidden(self, bsz):
        ...
        return (weight.new(PKTConfig.N_RNN_LAYER, bsz, PKTConfig.SZ_RNN_OUT).zero_(),
                weight.new(PKTConfig.N_RNN_LAYER, bsz, PKTConfig.SZ_RNN_OUT).zero_())
