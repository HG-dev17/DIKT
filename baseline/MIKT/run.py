...
def run_epoch(classify, model, optimizer, max_problem, path, batch_size, is_train, min_problem_num,
              max_problem_num,
              criterion, device, grad_clip, dataset):
    total_correct = 0
    total_num = 0
    total_loss = []
    ...
    data_loader = getLoader(max_problem, path, batch_size, is_train, min_problem_num, max_problem_num, dataset,device)
