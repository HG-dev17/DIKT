...
from config import BASICConfig, REKTConfig
...
if __name__ == '__main__':
    ...
    model_name = REKTConfig.MODEL_NAME
    d = REKTConfig.D
    dropout = REKTConfig.DROPOUT
    learning_rate = REKTConfig.LEARNING_RATE
    batch_size = REKTConfig.BATCH_SIZE
    max_seq = REKTConfig.SEQ_LEN
    min_seq = REKTConfig.MIN_SEQ_LEN
    epoch = REKTConfig.NUM_EPOCHS
    ...
    for fold in range(5):
        ...
        model = ReKT(skill_max, pro_max, d, dropout).to(device)
