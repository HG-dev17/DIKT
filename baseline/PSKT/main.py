...
from pskt import PSKT
from run import run_epoch
from config import BASICConfig, PSKTConfig
...
if __name__ == '__main__':
    ...
    model_name = PSKTConfig.MODEL_NAME
    embed_dim = PSKTConfig.EMBED_DIM
    learning_rate = PSKTConfig.LEARNING_RATE
    epoch = PSKTConfig.NUM_EPOCH
    batch_size = PSKTConfig.BATCH_SIZE
    max_seq = PSKTConfig.SEQ_LEN
    min_seq = PSKTConfig.MIN_SEQ_LEN
    patience = PSKTConfig.EARLY_STOP
    ...
    for fold in range(5):
        ...
        model = PSKT(pro_max, skill_max, embed_dim).to(device)
