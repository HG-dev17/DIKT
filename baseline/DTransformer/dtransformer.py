...
from config import DTRANSFORMERConfig

MIN_SEQ_LEN = DTRANSFORMERConfig.MIN_SEQ
...
class DTransformer(nn.Module):
    ...
    def get_cl_loss(self, q, s, pid=None):
        ...
        # prediction loss
        # masked_logits = logits[q != 0]
        # masked_labels = s[q != 0].float()
        ...
        # pred_loss + cl_loss * self.lambda_cl + reg_loss, pred_loss, cl_loss
        # TODO: weights
        return logits, cl_loss, reg_loss
